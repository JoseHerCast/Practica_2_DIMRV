...
//Cubemap del tipo skybox con U a 4 y V a 3
void CFiguras::skybox(float largo, float altura, float profundidad, GLuint text)  //Funcion creacion cielo
{
	...
	glTexCoord2f(0.25f, 0.333333); glVertex3fv(vertice[1]);
	glTexCoord2f(0.25f, 0.666666); glVertex3fv(vertice[7]);
	glTexCoord2f(0.5f, 0.666666); glVertex3fv(vertice[4]);
	glTexCoord2f(0.5f, 0.333333); glVertex3fv(vertice[0]);
	glEnd();

	glBegin(GL_POLYGON);	//Right
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.5f, 0.333333); glVertex3fv(vertice[0]);
	glTexCoord2f(0.75f, 0.333333); glVertex3fv(vertice[3]);
	glTexCoord2f(0.75f, 0.666666); glVertex3fv(vertice[5]);
	glTexCoord2f(0.5f, 0.666666); glVertex3fv(vertice[4]);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.75f, 0.666666); glVertex3fv(vertice[5]);
	glTexCoord2f(1.0f, 0.666666); glVertex3fv(vertice[6]);
	glTexCoord2f(1.0f, 0.333333); glVertex3fv(vertice[2]);
	glTexCoord2f(0.75f, 0.333333); glVertex3fv(vertice[3]);
	glEnd();
	...
	glTexCoord2f(0.25f, 0.333333); glVertex3fv(vertice[1]);
	glTexCoord2f(0.25f, 0.666666); glVertex3fv(vertice[7]);
	glTexCoord2f(0.0f, 0.666666); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.333333); glVertex3fv(vertice[2]);
	glEnd();

	glBegin(GL_POLYGON);  //Bottom
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.5,0.333333f); glVertex3fv(vertice[0]);//esq sup der
	glTexCoord2f(0.25,0.333333f); glVertex3fv(vertice[1]);//esq sup izq
	glTexCoord2f(0.25,0.0f); glVertex3fv(vertice[2]);//esq inf izq
	glTexCoord2f(0.5,0.0f); glVertex3fv(vertice[3]);//esq inf der
	glEnd();

	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.5, 0.666666f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.5, 1.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.25, 1.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.25, 0.666666f); glVertex3fv(vertice[7]);
	glEnd();
}
//Cubemap especial dedicado al cuarto de gohan
void CFiguras::cubemap(GLuint text, GLuint text2, GLuint text3, GLuint text4)  //Funcion creacion prisma
{
...
//Repite la textura 50 veces en U
void CFiguras::prisma_r_u(GLuint text, GLuint text2)  //Funcion creacion prisma
{
	...
	glTexCoord2f(50.0f, 1.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[7]);
	glEnd();
}
//Texturiza un prisma con la misma imagen en lados opuestos
void CFiguras::prisma_l_o(GLuint text, GLuint text2)  //Funcion creacion prisma
{
...
//Plano texturizado
void CFiguras::plano( GLuint text)  //Funcion creacion prisma
{
...
//Función para la creación de 1/2 de sección toroide no texturizada
void CFiguras::arco(GLfloat radioM, GLfloat radiom, int meridianos, int paralelos)
{
...
//Función para la creación de 1/4 de sección toroide no texturizada
void CFiguras::medio_arco(GLfloat radioM, GLfloat radiom, int meridianos, int paralelos)
{
...
//Función para la creación de 1/2 de sección de esfera 
void CFiguras::cup(GLfloat radio, int meridianos, int paralelos, GLuint text)
{
	GLdouble theta, phi;
...
//Función para la creación de texturas en 2D, pensadas para la GUI sobre la escena 3D
void CFiguras::texturaGUI(GLuint text) {

		GLfloat vertice[8][2] = {
					{0.5 ,-0.5},    //Coordenadas Vértice 0 V0
					{-0.5 ,-0.5},    //Coordenadas Vértice 1 V1
					{-0.5 ,0.5},    //Coordenadas Vértice 2 V2
					{0.5 ,0.5}    //Coordenadas Vértice 3 V3
